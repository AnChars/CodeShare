...
class CSMyheaderView: UIView {
    ...
    func configSubView(
        ...
        self.emailLable?.font = UIFont.systemFontOfSize(15)
    ...
    func setController(
        ...
        if index != nil {
            ...
            indexLable.font = UIFont.systemFontOfSize(15)
            ...
            supView.backgroundColor = UIColor ( red: 230/255.0, green: 245/255.0, blue: 245/255.0, alpha: 0.1 )
        }
        ...
        supView.snp_makeConstraints { (make) in
            ...
            make.width.equalTo(width).offset(2)
